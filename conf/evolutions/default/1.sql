...
create table "datas" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"feed_id" INTEGER NOT NULL,"feed_name" VARCHAR(254) NOT NULL,"feed_picture" VARCHAR(254),"feed_cover" VARCHAR(254),"version" BIGINT NOT NULL,"network" VARCHAR(254) NOT NULL,"media" VARCHAR(254) NOT NULL,"media_url" VARCHAR(254) NOT NULL,"preview_url" VARCHAR(254) NOT NULL,"text" VARCHAR(254) NOT NULL,"date" TIMESTAMP NOT NULL);
create index "datas_date_idx" on "datas" ("date");
create table "feed_populars" ("feed_id" INTEGER NOT NULL,"date_created" TIMESTAMP NOT NULL);
create unique index "feed_populars_idx_a" on "feed_populars" ("feed_id");
...
create table "feed_trendings" ("feed_id" INTEGER NOT NULL,"date_created" TIMESTAMP NOT NULL);
create unique index "feed_trendings_idx_a" on "feed_trendings" ("feed_id");
create table "feeds" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"version" BIGINT NOT NULL,"category" VARCHAR(254) NOT NULL,"name" VARCHAR(254) NOT NULL,"facebook_picture" VARCHAR(254),"facebook_cover" VARCHAR(254),"facebook_api" VARCHAR(254),"twitter_api" VARCHAR(254),"instagram_api" VARCHAR(254),"youtube_api" VARCHAR(254),"date_created" TIMESTAMP NOT NULL,"date_updated" TIMESTAMP NOT NULL,"location" VARCHAR(254) NOT NULL,"latitude" DOUBLE PRECISION NOT NULL,"longitude" DOUBLE PRECISION NOT NULL);
